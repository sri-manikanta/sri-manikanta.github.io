...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Sree Manikanta Portfolio";
            $("#favicon").attr("href", "assets/images/manis.png");
        }
    });
...
var typed = new Typed(".typing-text", {
    strings: ["Machine Learning", "Artificial Intelligence", "Natural Language Processing", "Generative AI"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 500,
